            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full bg-white hover:bg-gray-50 disabled:opacity-50 text-gray-700 font-semibold py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-2 border border-gray-300"
                >
                  {/* Google Logo SVG */}
